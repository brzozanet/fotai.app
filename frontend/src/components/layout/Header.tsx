...
export function Header() {
  ...
  return (
    <header className="material-enter-top sticky top-0 z-50 w-full bg-linear-to-r from-indigo-500 from-10% via-sky-600 via-30% to-emerald-500 to-80%px-6 py-4 shadow-2xl">
