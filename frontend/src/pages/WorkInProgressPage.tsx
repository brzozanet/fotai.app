    ...
    <>
      <div className="info-page mx-auto w-full max-w-5xl px-4 py-5 md:px-0">
        ...
        <p className="mb-4">
          ...
          powstaje z myślą o tym, by korzystanie z asystenta było wygodniejsze,
          bardziej osobiste i dostępne z każdego miejsca.
        </p>
        ...
        <p className="mb-4">
          ...
          <strong>założyć konto i zalogować się</strong> — a wtedy Twoje rozmowy
          z asystentem będą zapisane i dostępne zawsze, nawet po tygodniu
          przerwy, na telefonie, tablecie czy innym komputerze.
        </p>
        ...
        <p className="mb-4">
          ...
          ChatGPT lub podobnych narzędziach. Dzięki temu poczujesz, że asystent
          rzeczywiście odpowiada na żywo — bez czekania na kompletną wiadomość.
        </p>
        ...
        <p className="mb-4">
          ...
          można poprawić: czy kadr jest ciekawy, czy ekspozycja jest prawidłowa,
          gdzie oko widza naturalnie wędruje i dlaczego.
        </p>
        ...
        <p className="mb-4">
          ...
          możliwość{" "}
          <strong>edycji zdjęcia za pomocą zwykłych poleceń tekstowych</strong>.
          Zamiast żmudnego retuszu w programie graficznym napiszesz po prostu:
          „usuń drzewo z prawego rogu" albo „dodaj więcej dramatycznych chmur",
          a AI wykona to za Ciebie. Na ekranie zobaczysz oryginał i wynik obok
          siebie, a gotowe zdjęcie będzie można od razu pobrać.
        </p>
        ...
        <p className="mb-4">
          Prace trwają aktywnie. Robię to krok po kroku, żeby każda nowa funkcja
          działała niezawodnie, zanim pojawi się kolejna. Nie obiecuję
